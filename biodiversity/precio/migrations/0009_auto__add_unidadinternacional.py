...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UnidadInternacional'
        db.create_table('precio_unidadinternacional', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('precio', ['UnidadInternacional'])

    def backwards(self, orm):
        
        # Deleting model 'UnidadInternacional'
        db.delete_table('precio_unidadinternacional')
