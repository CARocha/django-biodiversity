...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Producto.variedad'
        db.delete_column('precio_producto', 'variedad_id')


    def backwards(self, orm):
        
        # Adding field 'Producto.variedad'
        db.add_column('precio_producto', 'variedad', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['precio.Variedad']), keep_default=False)
