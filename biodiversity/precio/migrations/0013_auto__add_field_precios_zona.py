...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Precios.zona'
        db.add_column('precio_precios', 'zona', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['diversity.Lugar'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Precios.zona'
        db.delete_column('precio_precios', 'zona_id')
    ...
    models = {
        ...
        'precio.precios': {
            ...
            'zona': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['diversity.Lugar']", 'null': 'True', 'blank': 'True'})
        },
        'precio.producto': {
