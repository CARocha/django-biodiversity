...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FotoInicio'
        db.create_table('diversity_fotoinicio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('leyenda', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('foto', self.gf('biodiversity.diversity.thumbs.ImageWithThumbsField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('diversity', ['FotoInicio'])


    def backwards(self, orm):
        
        # Deleting model 'FotoInicio'
        db.delete_table('diversity_fotoinicio')


    models = {
        'diversity.fotoinicio': {
            'Meta': {'object_name': 'FotoInicio'},
            'foto': ('biodiversity.diversity.thumbs.ImageWithThumbsField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leyenda': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
