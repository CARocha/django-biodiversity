...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pais.codigo_int'
        db.add_column('diversity_pais', 'codigo_int', self.gf('django.db.models.fields.CharField')(default='', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pais.codigo_int'
        db.delete_column('diversity_pais', 'codigo_int')
