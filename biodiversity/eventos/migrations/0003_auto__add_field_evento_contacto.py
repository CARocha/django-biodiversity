...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Evento.contacto'
        db.add_column('eventos_evento', 'contacto', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Evento.contacto'
        db.delete_column('eventos_evento', 'contacto')


    models = {
        'eventos.evento': {
            'Meta': {'object_name': 'Evento'},
            'contacto': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
