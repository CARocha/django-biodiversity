...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('forum_categories', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('forum', ['Categories'])

        # Adding model 'Forum'
        db.create_table('forum_forum', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Categories'])),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.create_table('forum_thread', (
            ...
            ('posts', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('visto', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('forum_categories')
    ...
    models = {
        ...
        'forum.forum': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forum.Categories']"}),
        ...
        'forum.thread': {
            'Meta': {'ordering': "['-time']", 'object_name': 'Thread'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'forum': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['forum.Forum']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'visto': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        }
    }
